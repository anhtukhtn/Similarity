...
def choice_1_1_MIN(dict_nouns):
  def _reset_params():
    Parameters.PARAMETERS_CHOICE_0_1.CHOICE_1_1_MIN = 0.05
  def _change_params_for_step(cur_step,alpha):
    _reset_params()
...
def choice_1_COL_MIN_FIRST(dict_nouns):
  def _reset_params():
    Parameters.PARAMETERS_CHOICE_0_1.CHOICE_1_COL_MIN_FIRST = 0.05
  def _change_params_for_step(cur_step,alpha):
    _reset_params()
...
def choice_N_N_MIN_FIRST(dict_nouns):
  def _reset_params():
    Parameters.PARAMETERS_CHOICE_0_1.CHOICE_N_N_MIN_FIRST = 0.05
  def _change_params_for_step(cur_step,alpha):
    _reset_params()
